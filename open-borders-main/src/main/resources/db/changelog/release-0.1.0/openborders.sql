...
insert into countries (id, name) values ( country_GREATBRITAIN_id.nextval, 'Великобритания' )
insert into countries (id, name) values ( country_INDIA_id.nextval, 'Индия' )
insert into countries (id, name) values ( country_CUBA_id.nextval, 'Куба' )
insert into countries (id, name) values ( country_TURKEY_id.nextval, 'Турция' )
insert into countries (id, name) values ( country_BULGARIA_id.nextval, 'Болгария' )
insert into countries (id, name) values ( country_DENMARK_id.nextval, 'Дания' )
insert into countries (id, name) values ( country_ITALY_id.nextval, 'Италия' )
insert into countries (id, name) values ( country_CANADA_id.nextval, 'Канада' )
